...
- The local operating-hub prototype and Drive HTML artifact include synthetic START HERE, Planning, Strategy, Library duplicate queue, Templates, Gate Review, Access, Content and Build views for launch-gate routing, delegated planning, template bundles, access decisions and build-backlog review; it is not a production deployment.
