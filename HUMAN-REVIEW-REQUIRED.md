...
This file contains only decisions requiring qualified human or expert review.
...
- Reason: Draft safety material cannot be operationally adopted without qualified review.
- Required reviewer: Qualified safeguarding professional and programme authority
- Status: open

## HR-002: Country-specific legal compliance

- Category: Legal review
- Reason: The operating system is intended for possible city or country expansion and local obligations vary.
- Required reviewer: Qualified legal advisor
- Status: open

## HR-003: Medical readiness and medication processes

- Category: Medical review
- Reason: Medical guidance requires qualified review before use.
- Required reviewer: Qualified medical professional
- Status: open

## HR-004: Theological and biblical content approval

- Category: Theology approval
